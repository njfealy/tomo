  ...
  return (
    <div className="grid grid-cols-[50%_50%] h-screen">
      <div className="grid place-content-center border-1 text-8xl bg-[#161616]">
        ...
        <div className="text-gray-50">tomo</div>
      </div>
      ...
      <div className="flex flex-col gap-10 justify-center items-center">
        ...
        <Link href="/home" className="border-[1.5] rounded-4xl w-[50%] bg-blue-400 px-10 py-2 text-2xl text-white text-center hover:bg-blue-600 transition">
          Sign Up
        </Link>
      </div>
    </div>
